...
struct VPK {
    ...
    VPKEntry findEntry(const std::string& filePath) const;
    /// Searches for a given file entry in the file list.
    VPKEntry findEntry(const std::string& directory, const std::string& fileName_) const;
    /// Searches for a given file entry in the file list.\n
    /// directory: Directory to search in\n
    /// fileName: File name to find, without the extension\n
    /// extension: File extension, without the leading dot
    VPKEntry findEntry(const std::string& directory, const std::string& fileName_, const std::string& extension) const;
